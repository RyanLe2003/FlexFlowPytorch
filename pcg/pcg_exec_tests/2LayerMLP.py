...
weight_1 = WeightNode(2, [], weight_node_1_attrs, [0])
...
weight_2 = WeightNode(3, [], weight_node_2_attrs, [0])
...
matmul_1 = MatmulNode(7, [4, 5], matmul_1_attrs, [0, 1])
...
relu_1 = ReluNode(10, [9], relu_1_attrs, [0, 1])
...
matmul_2 = MatmulNode(11, [10, 6], matmul_2_attrs, [0, 1])
...
relu_2 = ReluNode(12, [11], relu_2_attrs, [0, 1])
...
output = OutputNode(14, [13], output_attrs, [0])
